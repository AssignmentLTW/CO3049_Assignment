...
<body class="sub_page">
    ...
    <section class="detail_section ">
        <div class="container">
            <div class="title">
                <p><a href="../laptop.php">Laptops</a> &gt; <a href="#">Details</a> &gt; <a href="#">Laptop ASUS TUF
                        Gaming F15 FX506LH HN002T</a></p>
            </div>
            <div class="row">
                ...
                <div class=" box-large col-md-6 ">
                    ...
                    <div class="box-top">
                        <img id="big_img" class="img-fluid" src="../images/sp04-detail00.jpg" alt="Product">
                    </div>
                    <div class="box-bottom">
                        <div class="row">
                            <div class="col">
                                <a href="#" onclick="changeImage(1)"><img src="../images/sp04-detail01.jpg"
                                        alt="Product"></a>
                            </div>
                            <div class="col">
                                <a href="#" onclick="changeImage(2)"><img src="../images/sp04-detail02.jpg"
                                        alt="Product"></a>
                            </div>
                            <div class="col">
                                <a href="#" onclick="changeImage(3)"><img src="../images/sp04-detail03.jpg"
                                        alt="Product"></a>
                            </div>
                            <div class="col">
                                <a href="#" onclick="changeImage(4)"><img src="../images/sp04-detail04.jpg"
                                        alt="Product"></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-content">
                        <div id="info-product" class="tab-pane fade show active pt-3">
                            ...
                            <table class="table table-striped">
                                <tr>
                                    <th>CPU</th>
                                    <th>Intel Core i5-10300H 2.5GHz up to 4.5GHz 8MB</th>
                                </tr>
                                <tr>
                                    <th>RAM</th>
    ...
    function changeImage(image) {
        document.getElementById("big_img").src = "../images/sp04-detail0" + image + ".jpg";
    }
    </script>
    <!-- jQery -->
